...
- **`--branch`**: run `git diff $(git merge-base HEAD main)...HEAD` (adapt base branch from context or project instructions).
...
- **Respect project conventions.** Read the project instruction files (`CLAUDE.md`, `AGENTS.md`, or `GEMINI.md` — whichever exist at the project root) for project-specific security rules before dispatching the reviewer.
