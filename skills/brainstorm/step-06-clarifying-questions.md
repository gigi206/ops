...
Mark the task "Brainstorm: clarifying questions" as `in_progress` now via `TaskUpdate`.
...
Mark the task "Brainstorm: clarifying questions" as `completed` via `TaskUpdate`.
